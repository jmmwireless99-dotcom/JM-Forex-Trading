...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            "Asia BEST (PH 7AM–5PM): asia_m5_sr_scalp — fade Asia box edges",
            "Build Asia box from PH 7AM M5 high/low · fade sweep+rejection",
            "BUY box low / SELL box high · TP mid · no breakout chase",
            "Soft cutoff PH 4:30 — no new Asia scalps near London",
            "Next after 5PM → London BEST: gold_confluence",
            "Overlap/NY: gold_atr_trend · chop: gold_sr_scalp",
            "News / high ADX / Friday late → stand aside",
        ],
        ...
        "indicators": [
            "Asia session box (PH 7AM–5PM) high/low/mid",
            "M5 rejection wick at box edge (liquidity sweep fade)",
            "M5 ADX 14 (fade only when ranging)",
            "SL beyond box · TP Asia mid",
        ],
