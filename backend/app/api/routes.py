...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            ...
            "London/NY: trend tools or S/R supply-demand scalp · Asia 00–07 UTC: range fade",
            "London/NY range/pullback: revisit swing supply/demand zone + rejection candle",
            "Asia ranging: fade Donchian high/low + RSI + rejection candle",
            "Asia: skip if ADX wakes up (breakout risk toward London)",
            "London/NY trend: impulse → EMA21 pullback → confirm · TP ≥ 1.8R",
            "S/R scalp: SL beyond zone + ATR pad · TP opposite S/R or ~1.2R",
            "Asia scalp: SL beyond range edge · TP at mid-range (~1R)",
        ],
        "recommended_asia": "asia_range_scalp",
        "recommended_sr_scalp": "gold_sr_scalp",
        "indicators": [
            "M5 EMA 21 / 55 trend (London/NY trend days)",
            "M5 swing S/R supply-demand zones (London/NY range/pullback)",
            "M5 Donchian range + RSI fade (Asia)",
            "M5 ADX 14 (high=trend tools · low=S/R or Asia scalp)",
            "Zone / range-edge SL + R-multiple or opposite S/R TP",
        ],
