...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            ...
            "Asia BEST (PH 7AM–5PM): asia_m3m5_sr_scalp — M3 entry / M5 S/R",
            "Buy Support / sell Resistance on M3 rejection at M5 levels",
            "Next after 5PM → London BEST: gold_confluence",
            "Overlap BEST: gold_atr_trend · NY BEST: gold_atr_trend / confluence",
            "London/NY chop: gold_sr_scalp",
            "News / Friday late / off-hours / high ADX → stand aside",
        ],
        "recommended_asia": "asia_m3m5_sr_scalp",
        ...
        "indicators": [
            "M5 S/R structure + M3 rejection entry (Asia)",
            "Asia session range high/low as major S/R",
            "M5 ADX 14 (regime switch)",
            "Zone SL + opposite S/R or ~1.0R TP",
        ],
