...
@router.get("/downloads/gold-v620-tp30.zip")
...
async def download_gold_session_signal_zip() -> FileResponse:
    path = _release_file("gold-session-signal.zip")
    return FileResponse(path, filename="JM-GOLD-Session-Signal-Pack.zip", media_type="application/zip")
