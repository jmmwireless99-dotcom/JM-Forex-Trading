...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            ...
            "Asia BEST (PH 7AM–5PM): asia_m5_sr_scalp — M5 Support/Resistance",
            "Buy Support / sell Resistance on closed M5 rejection candle",
        ...
        "indicators": [
            "M5 swing Support/Resistance (Asia BEST)",
