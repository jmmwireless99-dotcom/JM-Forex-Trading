...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            "Asia desk only (PH 7:00AM–7:00PM) — scalp; flat after 7PM / weekend",
            "Decide only on closed M5 candle (not tick noise)",
            "Range: asia_range_scalp — fade Donchian high/low + RSI + rejection",
            "Pullback / mild trend: gold_sr_scalp — revisit supply/demand + rejection",
            "Volatile spikes: stand aside",
            "S/R scalp: SL beyond zone + ATR pad · TP opposite S/R or ~1.2R",
            "Asia range scalp: SL beyond range edge · TP at mid-range (~1R)",
        ],
        "recommended_asia": "asia_range_scalp",
        "recommended_sr_scalp": "gold_sr_scalp",
        "asia_desk_only": settings.asia_desk_only,
        "indicators": [
            "M5 Donchian range + RSI fade (Asia range)",
            "M5 swing S/R supply-demand zones (Asia pullback)",
            "M5 ADX 14 (high → S/R scalp · low → range fade · volatile → flat)",
