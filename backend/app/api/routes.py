...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            ...
            "RECOMMENDED Asia: asia_sr_scalp — M5 Support/Resistance fade",
            "Decide only on closed M5 candle (not tick noise)",
            "Buy Support / sell Resistance on rejection candle",
            "Levels: swing S/R + Asia session range high/low",
            "SL beyond level + ATR pad · TP opposite S/R or ~1.1R",
            "ADX rising / volatile / news → stand aside",
        ],
        "recommended_asia": "asia_sr_scalp",
        "recommended_sr_scalp": "asia_sr_scalp",
        "asia_desk_only": settings.asia_desk_only,
        "indicators": [
            "M5 swing Support / Resistance (Asia recommended)",
            "Asia session range high/low as major S/R",
            "M5 ADX 14 (high → flat · chop → S/R fade)",
            "Level SL + opposite S/R or ~1.1R TP",
        ],
