...
async def desk() -> dict:
    ...
    return {
        ...
        "entry_rules": [
            ...
            "London/NY: trend pullback (EMA+ADX+confirm) · Asia 00–07 UTC: range fade scalp",
            "Asia ranging: fade Donchian high/low + RSI + rejection candle",
            "Asia: skip if ADX wakes up (breakout risk toward London)",
            "London/NY: impulse → EMA21 pullback → confirm · TP ≥ 1.8R",
            "Asia scalp: SL beyond range edge · TP at mid-range (~1R)",
        ],
        "recommended_asia": "asia_range_scalp",
        "indicators": [
            "M5 EMA 21 / 55 trend (London/NY)",
            "M5 Donchian range + RSI fade (Asia)",
            "M5 ADX 14 (high=trend tools · low=Asia scalp)",
            "Structure / range-edge SL + R-multiple or mid-range TP",
        ],
